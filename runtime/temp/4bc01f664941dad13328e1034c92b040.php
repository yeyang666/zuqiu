<?php /*a:2:{s:68:"/Users/xieyang/project/tp5/application/admin/view/article/index.html";i:1612364663;s:67:"/Users/xieyang/project/tp5/application/admin/view/Common/index.html";i:1612453693;}*/ ?>
<!DOCTYPE>
...
<div id="dcMain"> <!-- 当前位置 -->
    <div class="mainBox imgModule">
        <h3><a href="<?php echo url('admin/article/view'); ?>"><button class="layui-btn layui-btn-normal" style="float:right;"><i class="layui-icon">&#xe654;</i>新增</button></a>文章列表</h3>
        <table width="100%" border="0" cellpadding="10" cellspacing="0" class="tableBasic">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr class="tron">
                    ...
                    <td><a href="<?php echo url('admin/article/view',['id'=>$vo['id']]); ?>" class="layui-btn layui-btn-xs"><i class="layui-icon">&#xe642;</i>修改</a>
                        <a href="javascript:void(0)" onclick="shanchu(<?php echo htmlentities($vo['id']); ?>)" class="layui-btn layui-btn-danger layui-btn-xs"><i class="layui-icon">&#xe640;</i>删除</a>
                    </td>
                </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
        </table>
        <div class="pager" style="float:right"><?php echo htmlentities($page); ?></div>
    </div>
</div>
<div class="clear"></div>
<div id="footer">
